...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone 10 LP" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=11 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=11 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone 10 LP" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=11 WIDTHDIST=4 aclr clk_en clock data distance result
...
module  Int10ToShortReal_altbarrel_shift_ivf
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[10:0]	sbit_piper1d;
	reg	[10:0]	sbit_piper2d;
	reg	sel_pipec2r1d;
	reg	sel_pipec3r1d;
	wire  [4:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 11'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[21:11];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 11'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[43:33];
	// synopsys translate_off
	initial
		sel_pipec2r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		pad_w = {8{1'b0}},
		result = sbit_w[54:44],
		sbit_w = {sbit_piper2d, smux_w[32:22], sbit_piper1d, smux_w[10:0], data},
		sel_w = {sel_pipec3r1d, sel_pipec2r1d, distance[1:0]},
		smux_w = {((({11{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[35:33], pad_w[7:0]}) | ({11{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[43:41]})) | ({11{(~ sel_w[3])}} & sbit_w[43:33])), ((({11{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[28:22], pad_w[3:0]}) | ({11{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[32:26]})) | ({11{(~ sel_w[2])}} & sbit_w[32:22])), ((({11{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[19:11], pad_w[1:0]}) | ({11{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[21:13]})) | ({11{(~ sel_w[1])}} & sbit_w[21:11])), ((({11{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[9:0], pad_w[0]}) | ({11{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[10:1]})) | ({11{(~ sel_w[0])}} & sbit_w[10:0]))};
endmodule //Int10ToShortReal_altbarrel_shift_ivf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //Int10ToShortReal_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //Int10ToShortReal_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	Int10ToShortReal_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	Int10ToShortReal_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //Int10ToShortReal_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	Int10ToShortReal_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	Int10ToShortReal_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //Int10ToShortReal_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	Int10ToShortReal_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	Int10ToShortReal_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //Int10ToShortReal_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	Int10ToShortReal_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	Int10ToShortReal_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //Int10ToShortReal_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	Int10ToShortReal_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	Int10ToShortReal_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //Int10ToShortReal_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 135 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int10ToShortReal_altfp_convert_81n
	( 
	clock,
	dataa,
	result) ;
	...
	wire  [10:0]   wire_altbarrel_shift5_result;
	...
	reg	[9:0]	mag_int_a_reg;
	reg	[9:0]	mag_int_a_reg2;
	...
	wire  [10:0]  prio_mag_int_a;
	wire  [4:0]  priority_pad_one_w;
	wire  [31:0]  result_w;
	wire  [9:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [3:0]  zero_padding_w;

	Int10ToShortReal_altbarrel_shift_ivf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Int10ToShortReal_altpriority_encoder_rb6   altpriority_encoder2
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 10'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 10'b0;
	...
	assign
		...
		clk_en = 1'b1,
		const_bias_value_add_width_int_w = 8'b10001000,
		...
		mag_int_a = (({10{(~ sign_int_a)}} & int_a) | ({10{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[22:0],
		mantissa_pre_round = {shifted_mag_int_a[9:0], {14{1'b0}}},
		mantissa_rounded = mantissa_pre_round_reg,
		max_neg_value_selector = (wire_cmpr4_alb & sign_int_a_reg2),
		max_neg_value_w = 8'b10001001,
		minus_leading_zero = {zero_padding_w, leading_zeroes},
		prio_mag_int_a = {mag_int_a_reg, 1'b1},
		priority_pad_one_w = {5{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift5_result[9:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[10],
		zero_padding_w = {4{1'b0}};
endmodule //Int10ToShortReal_altfp_convert_81n
//VALID FILE
...
module Int10ToShortReal (
	...
	Int10ToShortReal_altfp_convert_81n	Int10ToShortReal_altfp_convert_81n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
